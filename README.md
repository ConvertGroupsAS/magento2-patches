...
clerk/magento2|Patch-Clerk-4.7.7-empty-body-params.patch|                                          Empty request body params causes wrong resolving store based on passed credentials and in effect wrong indexation                                           |
